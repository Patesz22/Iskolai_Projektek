...
======================================*/
    ...
    // 3.Countdown timer 
        ...
        function makeTimer() {
                ...
                var endTime = new Date("December 31, 2021 23:59:00 GMT+1");            
                ...
                $("#Nap").html(days + '<span class="camp">Nap</span>');
                $("#Óra").html(hours + '<span class="camp">Óra</span>');
                $("#Perc").html(minutes + '<span class="camp">Perc</span>');
                $("#Másodperc").html(seconds + '<span class="camp">Másodperc</span>');       
