...
def main_menu(wallet, nev):
    ...
    print("[1] Roulette     [4] Horses          [7] Pénzkivétel")
    print("[2] Slots        [5] Scoreboard      [8] Láda")
    print(f"[3] Blackjack    [6] Pénzbefizetés   {Fore.RED}[9] Kilépsés{Fore.WHITE}" + "\n")
...
def betCheck(wallet, bet, nev):
    ...
    if wallet == 0:
        print("Nincs pénzed! Te CSÖVES!")
        time.sleep(3)
        main_menu(wallet, nev)

    if bet > int(wallet):
        print("Biztos van ehhez elég pénzed?")
        time.sleep(1.4)
        main_menu(wallet, nev)
...
def depositPenz(wallet, nev):
    ...
    print(f"Sikeresen bevizettél {deposit}HUF összeget!")
    time.sleep(2)
...
def withdrawPenz(wallet, nev):
    ...
    print(f"Sikeresen kivettél {withdrawal}HUF összeget!")
    time.sleep(2)
    main_menu(wallet, nev)
...
def slots(wallet, nev):
    ...
    print("\n[0] Fő menü \n")
    print(f"[1]{Fore.RED} Tycoon Maniya{Fore.WHITE}\n")
...
def roulette(wallet, nev):
    ...
    Az alábbiakra rakhatsz tétet:
        ...
        if mire.lower() == "vissza":
            ...
            kicsi_val = int(input("Menyik számra? (1 - 18): "))
            while kicsi_val not in range(1, 18):
            ...
            nagy_val = int(input("Menyik számra? (19 - 36): "))
    ...
    if red == True and red_szamok.__contains__(win_szam):
        red_bet *= 2
        bet2 += red_bet
        nyert += "Piros, "

    if black == True and black_szamok.__contains__(win_szam):
        black_bet *= 2
        bet2 += black_bet
        nyert += "Fekete, "

    if paros == True and paros_szamok.__contains__(win_szam):
        paros_bet *= 2
        bet2 += paros_bet
        nyert += "Páros, "

    if paratlan == True and paratlan_szamok.__contains__(win_szam):
        paratlan_bet *= 2
        bet2 += paratlan_bet
        nyert += "Páratlan, "

    if nulla == True and 0 == win_szam:
        nulla_bet *= 36
        bet2 += nulla_bet
        nyert += "Nulla, "

    if kicsi == True and kicsi_val == win_szam:
        kicsi_bet *= 2
        bet2 += nulla_bet
        nyert += "Kicsi, "

    if nagy == True and nagy_val == win_szam:
        nagy_bet *= 2
        bet2 += nagy_bet
        nyert += "Nagy, "

    if sor == True and sor_val == win_szam:
        sor_bet *= 3
        bet2 += sor_bet
        nyert += "Sor, "

    if szamok == True and szamok_val == win_szam:
        szamok_bet *= 2
        bet2 += szamok_bet
        nyert += str(win_szam) + ", "
    ...
    if red is True or black is True or paros is True or paratlan is True or nulla is True or kicsi is True or nagy is True or sor is True or szamok is True:
...
def blackjack(wallet, nev, totalDealer=0, totalPlayer=0, game_continued=False):
    ...
    while stbet.lower() == "k":
        ...
        if stbet.lower() == "k":
            ...
            if totalPlayer <= 21:
                ...
                print(f"Túlmentél! Ezért automatikusan megállsz\n")
                break

    winnings = bet * 2
    winningsbj = bet * 2.5

    if stbet.lower() == "m" and totalPlayer <= 21:
        print("\nMegálltál.\n")
        time.sleep(1)
    ...
    while totalDealer <= 17 and totalPlayer <= 21:
...
def fire_joker(wallet, nev):
    ...
    for i in range(kor):
        ...
        if random_lane1.startswith("Fire Joker") & random_lane2.startswith("Fire Joker") & random_lane3.startswith("Fire Joker"):
            ...
            scoreboardsave(gameData="Fire_Joker", winData=winning_jackpot, szorzoData=round(winning_jackpot / bet, 3), betData=bet,
                           wallet=wallet, nev=nev)
            time.sleep(2)
            ...
            print(winner)
            wallet += winning1
            scoreboardsave(gameData="Fire_Joker", winData=winning1,
...
def tycoon(wallet, nev):
    ...
    pepper = [f'Black Pepper', f'{Fore.RED}Red Pepper', f'{Fore.GREEN}Green Pepper{Fore.WHITE}']
    ...
    print(f"----[{Fore.RED}Tycoon Manya{Fore.WHITE}]----")
    print(f"\nHa {Fore.CYAN}0{Fore.WHITE} tétet raksz, visszalépsz a főmenübe!")
    ...
    for i in range(kor):
        ...
        if random_pepper.startswith("Black") & random_apple.startswith("Black") & random_lemon.startswith("Black"):
            print(winner)
            wallet += winnings
            scoreboardsave(gameData="Tycoon", winData=winnings,
...
def sweet_bonanza(wallet, nev):
    ...
    lane1 = [f'{Fore.BLACK}Bonus Bomb, {Fore.MAGENTA}Grapes, {Fore.LIGHTYELLOW_EX}Banana, {Fore.YELLOW}Lemon, {Fore.LIGHTGREEN_EX}Pear, {Fore.LIGHTRED_EX}Strawberry{Fore.WHITE}']
    lane2 = [f'{Fore.BLACK}Bonus Bomb, {Fore.MAGENTA}Grapes, {Fore.LIGHTYELLOW_EX}Banana, {Fore.YELLOW}Lemon, {Fore.LIGHTGREEN_EX}Pear, {Fore.LIGHTRED_EX}Strawberry{Fore.WHITE}']
    lane3 = [f'{Fore.BLACK}Bonus Bomb, {Fore.MAGENTA}Grapes, {Fore.LIGHTYELLOW_EX}Banana, {Fore.YELLOW}Lemon, {Fore.LIGHTGREEN_EX}Pear, {Fore.LIGHTRED_EX}Strawberry{Fore.WHITE}']

    print(f'----[{Fore.BLUE}Sweet Bonanza{Fore.WHITE}]----')
    print(f"\nHa {Fore.CYAN}0{Fore.WHITE} tétet raksz, visszalépsz a főmenübe!")
    ...
    for i in range(kor):
        ...
        if random_lane1.startswith("Bonus Bomb") & random_lane2.startswith("Bonus Bomb") & random_lane3.startswith("Bonus Bomb"):
            ...
            scoreboardsave(gameData="Sweet_Bonanza", winData=bbmPlusBet, szorzoData=bbm, betData=bet, wallet=wallet, nev=nev)
            time.sleep(3)
            sweet_bonanza(wallet, nev)
            ...
            wallet += bbmPlusBet
            print(f"{Fore.LIGHTGREEN_EX}Gratulálok, nyertél!: {bbmPlusBet}HUF\n {Fore.LIGHTBLUE_EX}Szorzó: {bbm}x{Fore.WHITE}")
            scoreboardsave(gameData="Sweet_Bonanza", winData=bbmPlusBet, szorzoData=bbm, betData=bet, wallet=wallet,
                           nev=nev)
            time.sleep(3)
            sweet_bonanza(wallet, nev)
